    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
          ...
          {/* ── Logo ── */}
          <Link to="/" className="flex items-center gap-1.5 sm:gap-2.5 select-none flex-shrink-0 ml-0 sm:-ml-[50px]">
            <img
            ...
            <div className="flex flex-col leading-none">
              <span className="font-serif text-xl sm:text-2xl font-bold text-primary tracking-wide leading-none">
                SRLN
              </span>
              <span className="font-sans text-[9px] sm:text-[11px] font-semibold text-secondary tracking-[0.12em] sm:tracking-[0.18em] leading-none mt-0.5">
